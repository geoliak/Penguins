...
public class Settings {
	...
	String path;
	if (Musique.isPlay()) {
	    path = "img_menu/note.jpg";
	} else {
	    path = "img_menu/note_croix.png";
	}
	File fnote = new File(path);
	ImageView note = new ImageView(Settings.class.getClassLoader().getResource(fnote.toURI().toString()).toString());
	tooltip = new Tooltip();
