...
public class FenetreJeuControllerReseau {

    public void creerFenetreJeu(Stage stage, ClientJeu client) {
	...
	AnimationFXReseau a = new AnimationFXReseau();
	DessinateurFXReseau d = new DessinateurFXReseau(root, a, client);
	...
	//plateau.accept(d);
	RafraichissementFXReseau r = new RafraichissementFXReseau(d, client);
	r.start();
	stage.show();
    }
